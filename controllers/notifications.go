...
// @Param	body		body 	models.Notifications	true		"body for Notifications content"
// @Success 201 {int} models.Notifications
// @Failure 403 body is empty
// @router / [post]
func (c *NotificationsController) Post() {
	var v models.Notifications
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddNotifications(&v); err == nil {
...
func (c *NotificationsController) Put() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateNotificationsById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
